# Generated by Django 4.2.7 on 2023-12-09 15:30
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('summary', models.TextField(blank=True)),
                ('assistant', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='assistants.assistant')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('goal', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='timeline', to='goals.goal')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('timeline_item', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='responsibilites', to='goals.timelineitem')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.AddField(
            model_name='goal',
            name='parent',
            field=models.ForeignKey(blank=True, default=None, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='children', to='goals.goal'),
        ),
        migrations.AddField(
            model_name='goal',
            name='properties',
